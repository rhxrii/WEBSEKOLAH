...
<body>
    ...
    <div class="container blog py-5">
        ...
        <a class="btn btn-primary rounded-pill py-3 px-5 mt-2" href="{{route('tentang')}}">Foto</a>
        <a class="btn btn-primary rounded-pill py-3 px-5 mt-2" href="{{route('tentang')}}">Video</a>
