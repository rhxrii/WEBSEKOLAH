...
<body>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-3 mb-4 my-responsive-text">Profil</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Beranda</a></li>
                    <li class="breadcrumb-item active text-white">Profil</li>
                    <li class="breadcrumb-item active text-white">Sekolah</li>
    ...
    <div class="container blog py-5">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center gallery-item h-100">
                @if($sekolah == Null)
            ...
            <div class="col-md-12 mt-3 d-flex justify-content-center">
                Tahun Didirikan : {{$sekolah->tahun ?? 'Tidak Ada Data'}}
            </div>
            <div class="col-md-12 mt-3">
               <p> {{$sekolah->deskripsi ?? 'Tidak Ada Data'}} </p>
            </div>
        </div>
