...
.bg-breadcrumb {
    background: linear-gradient(rgba(19, 53, 123, 0.5), rgba(19, 53, 123, 0.5)), url('{{asset("GBERITA/". $berita->gberita)}}');
  ...
  .my-responsive-text {
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-3 mb-4 my-responsive-text">{{$berita->judul}}</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Beranda</a></li>
                    <li class="breadcrumb-item"><a href="#">Berita</a></li>
                    <li class="breadcrumb-item active text-white">{{$berita->id}}</li>
    ...
    <div class="container blog py-5">
        <div class="row">
            <div class="col-md-12" >
            <p style="font-size: 2vw;" class="my-responsive-text text-justify">{!! $berita->deskripsi !!}</p>
