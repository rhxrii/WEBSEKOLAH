...
<body>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-3 mb-4 my-responsive-text">Informasi</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Beranda</a></li>
                    <li class="breadcrumb-item active text-white">Informasi</li>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <div class="blog-img">
                        <div class="blog-img-inner">
                            <img class="img-fluid w-100 rounded-top card-img-top"
                                src="{{asset('GINFORMASI/'.$iinf->ginformasi)}}" alt="Image">
                            <div class="blog-icon">
                                <a href="{{route('bacainformasi', $iinf->id)}}" class="my-auto"><i
                    ...
                    <div class="blog-content border border-top-0 rounded-bottom p-4">
                        ...
                        <a href="{{route('bacainformasi', $iinf->id)}}"
                            class="h4">{{Str::limit($iinf->judul_informasi, 20, '....')}}</a>
