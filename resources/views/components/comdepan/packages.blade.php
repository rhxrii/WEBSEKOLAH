<div class="container-fluid packages py-5">
        <div class="container py-5">
            <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                ...
                <h1 class="mb-0">INFORMASI TERUPDATE</h1>
            </div>
            <div class="packages-carousel owl-carousel">
                @foreach($info as $iinf)
                <div class="packages-item">
                    <div class="packages-img">
                        <img src="{{asset('GINFORMASI/'. $iinf->ginformasi)}}" class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute"
                            style="width: 100%; bottom: 0; left: 0; z-index: 5;">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt me-2"></i>{{$iinf->judul_informasi}}</small>
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-calendar-alt me-2"></i>{{$iinf->tag_informasi}}</small>
